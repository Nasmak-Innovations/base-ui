				...
				<div className="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
										...
										<div className="flex">
											...
											<div className="ml-auto">
												<div className="report-box__indicator bg-theme-9 tooltip cursor-pointer"
													...
													data-feather="chevron-up" className="w-4 h-4"></i></div>
											</div>
										</div>
						...
						<div className="intro-y box p-5 mt-12 sm:mt-5">
							<div className="flex flex-col xl:flex-row xl:items-center">
								<div className="flex">
									...
									<div
										className="w-px h-12 border border-r border-dashed border-gray-300 mx-4 xl:mx-6"></div>
									<div>
								...
								<div className="dropdown relative xl:ml-auto mt-5 xl:mt-0">
									<button
										className="dropdown-toggle button font-normal border text-white relative flex items-center text-gray-700"> Filter
										by Category <i data-feather="chevron-down" className="w-4 h-4 ml-2"></i>
									</button>
									<div className="dropdown-box mt-10 absolute w-40 top-0 xl:right-0 z-20">
										<div className="dropdown-box__content box p-2 overflow-y-auto h-32"><a href=""
																											   className="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">PC
											& Laptop</a> <a href=""
															className="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">Smartphone</a>
											<a href=""
											   className="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">Electronic</a>
											<a href=""
											   className="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">Photography</a>
											<a href=""
											   className="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md">Sport</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div className="intro-y block sm:flex items-center h-10">
							...
							<div className="sm:ml-auto mt-3 sm:mt-0 relative text-gray-700">
								<i data-feather="map-pin"
								   className="w-4 h-4 z-10 absolute my-auto inset-y-0 ml-3 left-0"></i>
								<input type="text" className="input w-full sm:w-40 box pl-10"
					...
					<div className="col-span-12 xl:col-span-4 mt-6">
						...
						<div className="mt-5">
							...
							<a href=""
							   className="intro-y w-full block text-center rounded-md py-4 border border-dotted border-theme-15 text-theme-16">View
								More</a>
						</div>
					</div>
						...
						<div className="col-span-12 sm:col-span-6 xxl:col-span-3 intro-y">
							<div className="mini-report-chart box p-5 zoom-in">
								<div className="flex">
									...
									<div
										className="py-1 px-2 rounded-full text-xs bg-gray-200 text-gray-600 cursor-pointer ml-auto truncate">320
										Followers
									</div>
								</div>
								<div className="mt-4">
						...
						<div className="col-span-12 sm:col-span-6 xxl:col-span-3 intro-y">
							<div className="mini-report-chart box p-5 zoom-in">
								<div className="flex">
									...
									<div
										className="py-1 px-2 rounded-full text-xs bg-gray-200 text-gray-600 cursor-pointer ml-auto truncate">180
										Campaign
									</div>
								</div>
								<div className="mt-4">
					...
					<div className="col-span-12 mt-6">
						<div className="intro-y block sm:flex items-center h-10">
							...
							<div className="flex items-center sm:ml-auto mt-3 sm:mt-0">
								<button className="button box flex items-center text-gray-700"><i
									data-feather="file-text" className="hidden sm:block w-4 h-4 mr-2"></i> Export to
									Excel
								</button>
								<button className="ml-3 button box flex items-center text-gray-700"><i
								...
								<tr className="intro-x">
									<td className="w-40">
										<div className="flex">
											...
											<div className="w-10 h-10 image-fit zoom-in -ml-5">
												<img alt="Midone Tailwind HTML Admin Template"
													 className="tooltip rounded-full" src="dist/images/preview-11.jpg"
								...
								<tr className="intro-x">
									<td className="w-40">
										<div className="flex">
											<div className="w-10 h-10 image-fit zoom-in">
												<img alt="Midone Tailwind HTML Admin Template"
													 className="tooltip rounded-full" src="dist/images/preview-9.jpg"
									...
									<td>
										...
										<div
											className="text-gray-600 text-xs whitespace-no-wrap">Smartphone &amp; Tablet
										</div>
									</td>
					...
					<div className="xxl:pl-6 grid grid-cols-12 gap-6">
						<div className="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
							...
							<div className="mt-5">
								...
								<a href=""
								   className="intro-x w-full block text-center rounded-md py-3 border border-dotted border-theme-15 text-theme-16">View
									More</a>
							</div>
						</div>
							...
							<div className="report-timeline mt-5 relative">
								...
								<div className="intro-x relative flex items-center mb-3">
									...
									<div className="box px-5 py-3 ml-4 flex-1 zoom-in">
										...
										<div className="text-gray-600 mt-1">Has changed <a className="text-theme-1"
																						   href="">Sony Master Series
											A9G</a> price and description
										</div>
									</div>
								</div>
								<div className="intro-x relative flex items-center mb-3">
								...
								<div className="slick-carousel box zoom-in" id="important-notes">
									<div className="p-5">
										...
										<div className="font-medium flex mt-5">
											<button type="button"
													className="button button--sm bg-gray-200 text-gray-600">View Notes
											</button>
											<button type="button"
													className="button button--sm border border-gray-300 text-gray-600 ml-auto">Dismiss
											</button>
										</div>
									</div>
									<div className="p-5">
						...
						<div
							...
							<div className="intro-x flex items-center h-10">
								...
								<a href="" className="ml-auto text-theme-1 truncate flex items-center"> <i
