                    ...
                    <div className="block xl:grid grid-cols-2 gap-4">
                        ...
                        <div className="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                            <div
                                ...
                                <div className="intro-x mt-2 text-gray-500 xl:hidden text-center">A few more clicks to Recover to your
                                ...
                                {/* <div className="intro-x flex text-gray-700 text-xs sm:text-sm mt-4">
                                    <div className="flex items-center mr-auto">
                                        ...
                                        <label className="cursor-pointer select-none" htmlFor="remember-me">try another way</label>
                                    </div>
                                    <a href="">Try Another Way </a>
                                </div> */}
                                <div className="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                                    <button className="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3">Next</button>
                                    {/* <button
                                ...
                                <div className="intro-x mt-10 xl:mt-24 text-gray-700 text-center xl:text-left">
                                    <a className="text-theme-1" href="">Terms and Conditions</a> and <a className="text-theme-1" href="">Privacy
                                     Policy</a>
                                </div>
                            </div>
                        </div>
