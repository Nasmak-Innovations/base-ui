		...
		return (
			<nav className="side-nav">
				<a href="" className="intro-x flex items-center pl-5 pt-4">
					...
					<span className="hidden xl:block text-white text-lg ml-3"> Mid
							<span
								className="font-medium">one</span>
						</span>
				</a>
				...
				<ul>
					...
					{/*		<div className="side-menu__title"> Menu Layout <i data-feather="chevron-down"*/}
					{/*														  className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					...
					{/*</li>*/}
					<li>
						<Link to={"/inbox"} className="side-menu">
					...
					{/*		<div className="side-menu__title"> Crud <i data-feather="chevron-down"*/}
					{/*												   className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					...
					{/*		<div className="side-menu__title"> Users <i data-feather="chevron-down"*/}
					{/*													className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					...
					{/*		<div className="side-menu__title"> Profile <i data-feather="chevron-down"*/}
					{/*													  className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					...
					{/*		<div className="side-menu__title"> Pages <i data-feather="chevron-down"*/}
					{/*													className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					{/*			<a href="javascript:;" className="side-menu">*/}
					{/*				<div className="side-menu__icon"><i data-feather="activity"></i></div>*/}
					{/*				<div className="side-menu__title"> Wizards <i data-feather="chevron-down"*/}
					{/*															  className="side-menu__sub-icon"></i>*/}
					{/*				</div>*/}
					{/*			</a>*/}
					{/*			<ul className="">*/}
					{/*				<li>*/}
					...
					{/*			<a href="javascript:;" className="side-menu">*/}
					{/*				<div className="side-menu__icon"><i data-feather="activity"></i></div>*/}
					{/*				<div className="side-menu__title"> Blog <i data-feather="chevron-down"*/}
					{/*														   className="side-menu__sub-icon"></i>*/}
					{/*				</div>*/}
					{/*			</a>*/}
					{/*			<ul className="">*/}
					...
					{/*			<a href="javascript:;" className="side-menu">*/}
					{/*				<div className="side-menu__icon"><i data-feather="activity"></i></div>*/}
					{/*				<div className="side-menu__title"> Pricing <i data-feather="chevron-down"*/}
					{/*															  className="side-menu__sub-icon"></i>*/}
					{/*				</div>*/}
					{/*			</a>*/}
					{/*			<ul className="">*/}
					...
					{/*			<a href="javascript:;" className="side-menu">*/}
					{/*				<div className="side-menu__icon"><i data-feather="activity"></i></div>*/}
					{/*				<div className="side-menu__title"> Invoice <i data-feather="chevron-down"*/}
					{/*															  className="side-menu__sub-icon"></i>*/}
					{/*				</div>*/}
					{/*			</a>*/}
					{/*			<ul className="">*/}
					...
					{/*			<a href="javascript:;" className="side-menu">*/}
					{/*				<div className="side-menu__icon"><i data-feather="activity"></i></div>*/}
					{/*				<div className="side-menu__title"> FAQ <i data-feather="chevron-down"*/}
					{/*														  className="side-menu__sub-icon"></i></div>*/}
					{/*			</a>*/}
					{/*			<ul className="">*/}
					{/*				<li>*/}
					...
					{/*		<div className="side-menu__title"> Components <i data-feather="chevron-down"*/}
					{/*														 className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					{/*			<a href="javascript:;" className="side-menu">*/}
					{/*				<div className="side-menu__icon"><i data-feather="activity"></i></div>*/}
					{/*				<div className="side-menu__title"> Grid <i data-feather="chevron-down"*/}
					{/*														   className="side-menu__sub-icon"></i>*/}
					{/*				</div>*/}
					{/*			</a>*/}
					{/*			<ul className="">*/}
					...
					{/*		<div className="side-menu__title"> Forms <i data-feather="chevron-down"*/}
					{/*													className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
					...
					{/*	<a href="javascript:;" className="side-menu">*/}
					{/*		<div className="side-menu__icon"><i data-feather="hard-drive"></i></div>*/}
					{/*		<div className="side-menu__title"> Widgets <i data-feather="chevron-down"*/}
					{/*													  className="side-menu__sub-icon"></i></div>*/}
					{/*	</a>*/}
					{/*	<ul className="">*/}
					{/*		<li>*/}
